...
def test_depends():
  ...
  def chill_on_strict(a, b):
    return chill_fn(a, b) + multiply_wrapper(a, b)

  assert set(chill_fn.depends) == {chill_fn.fn, helper, multiply_wrapper, global_multiply}
  assert set(chill_on_strict.depends) == {chill_on_strict.fn, chill_fn, multiply_wrapper, global_multiply}
